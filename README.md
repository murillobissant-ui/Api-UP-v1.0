# UpSysteM API v1.4.16 — PostgreSQL/Supabase
...
A partir da v1.4.16, a API mantém as logs sob duas regras simultâneas:
...
## Logs do Sistema
A partir da v1.4.16, os erros técnicos são separados dos ciclos operacionais.
