# UpSysteM API v1.0.1 — PostgreSQL/Supabase
...
A partir da v1.0.1, a API mantém as logs sob duas regras simultâneas:
...
## Logs do Sistema
A partir da v1.0.1, os erros técnicos são separados dos ciclos operacionais.
