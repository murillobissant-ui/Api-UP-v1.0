# UpSysteM API v1.4.10 — PostgreSQL/Supabase
...
A partir da v1.4.10, a API mantém as logs sob duas regras simultâneas:
...
## Logs do Sistema
A partir da v1.4.10, os erros técnicos são separados dos ciclos operacionais.
